...
class ProfileHeader: UICollectionReusableView {
  ...
  private lazy var editProfileButton: UIButton = {
    ...
    button.addTarget(self, action: #selector(handleEditProfileFollowClicked), for: .touchUpInside)
    return button
  }()
  ...
  private lazy var followersLabel: UILabel = {
    ...
    label.numberOfLines = 0
    label.textAlignment = .center
    label.attributedText = attributedStatText(value: 1250, label: "followers")
    return label
  }()
  ...
  override init(frame: CGRect) {
    ...
    profileImageView.anchor(top: topAnchor, left: leftAnchor, paddingTop: 16, paddingLeft: 15)
  ...
  // MARK: - Actions
  @objc func handleEditProfileFollowClicked() {
    print("DEBUG: Clicked!")
  }
